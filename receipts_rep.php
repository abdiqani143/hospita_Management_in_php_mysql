...
<html class="no-js" lang="en">
   ...
   <head>
    ...
    <body>
      ...
      <select style="width:200px; height:40px" id="doctor">
          <option selected disabled value="">Select Receipts</option>
          <?php $co->FillCombo("SELECT `Bukaan`,`Bukaan` FROM `receipt_view` ");?>
      </select>
 ...
 $(document).ready(function() {
    $('#example').DataTable();
    $("#divTable").load("reports/receipt_report_all.php");
 ...
 $("#doctor").change(function(){
    var name=$(this).val();
    $.post("reports/receipt_report_indi.php","name="+name,function(res){
       $("#divTable").html(res); 
    })
 })
 //.................
