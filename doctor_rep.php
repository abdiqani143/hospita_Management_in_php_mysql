...
<html class="no-js" lang="en">
   ...
   <head>
    ...
    <body>
      ...
      <select style="width:200px; height:40px" id="doctor">
          ...
          <?php $co->FillCombo("SELECT `Docter`,`Docter` FROM `employee_view` ");?>
      </select>
 ...
 $(document).ready(function() {
    $('#example').DataTable();
    $("#divTable").load("reports/doctor_report_all.php");
 ...
 $("#doctor").change(function(){
    var name=$(this).val();
    $.post("reports/docor_report_indi.php","name="+name,function(res){
       $("#divTable").html(res); 
    })
 })
 //.................
