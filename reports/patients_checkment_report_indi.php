...
<div class="container">
  <div class="header">
    <img src="patient-checkment.jpg">
  </div>	
	<table id="example" class="table table-striped table-bordered table-condensed" >
		<br>
		 <!-- <tr><h6 class="text-center"><b>All REPORT</b></h6></tr> -->
		<thead>
		<tr><th>NO</th><th>Magaca</th><th>Bukaan</th><th>Taariikhda</th><th>Checkment</th><th>Jawaab</th><th>Description</th></tr>
		</thead>
		<tbody>
			<?php 
				$sql=mysqli_query($co->db,"SELECT * FROM `patient_checkment_view` where Decter='$name'"); 
