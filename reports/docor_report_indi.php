...
<div class="container">
  <div class="header">
	...
	<table id="example" class="table table-striped table-bordered table-condensed" >
		...
		<thead>
		<tr><th>NO</th><th>Magaca</th><th>Talefoonka</th><th>Jinsiga</th><th>Dagmada</th><th>Xaafada</th><th>Job_Title</th><th>Specialization</th></tr>
		</thead>
		<tbody>
			<?php 
				$sql=mysqli_query($co->db,"SELECT * FROM `employee_view` where Docter='$name'"); 
