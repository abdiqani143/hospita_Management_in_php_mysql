...
<div class="container">
  <div class="header">
	...
	<table id="example" class="table table-striped table-bordered table-condensed" >
		...
		<thead>
		<tr><th>NO</th><th>Magaca</th><th>Bukaan</th><th>Tarikhda</th><th>Daawo</th><th>Description</th></tr>
		</thead>
		<tbody>
			<?php 
				$sql=mysqli_query($co->db,"SELECT * FROM `prescription_view` where Dector='$name'"); 
