   ...
   <head>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                <?php include"Modal/SpecializationModal.php"; ?>
                <?php include"file/sidebar.php"; ?>
                <div class="main-content">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add Specialization</button> <br><br>
                    <div class="container-fluid">
                      <!--   <h1>hello</h1> -->
                        <?php $co->viewTable("select * from specialization_view") ?>
...
$(".btnEdit").click(function(){
   id=$(this).attr("update");
    ...
    var sql="select * from specialization where sp_no= '"+id+"' ";
...
$.post("file/operations.php",$("#fmEdit").serialize()+"&oper=update&id="+id, function(res){
  alert(res);
  window.location='specialization.php';
