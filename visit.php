   ...
   <head>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                <?php include"Modal/VisitModal.php"; ?>
                <?php include"file/sidebar.php"; ?>
                <div class="main-content">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add-Visit</button> <br> <br>
                    <div class="container-fluid">
                      <!--   <h1>hello</h1> -->
                        <?php $co->viewTable("select * from visit_view") ?>
...
$(".btnEdit").click(function(){
   id=$(this).attr("update");
    ...
    var sql="select * from visit where v_no= '"+id+"' ";
