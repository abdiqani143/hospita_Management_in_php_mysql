...
<html class="no-js" lang="en">
   ...
   <head>
       ...
       <style type="text/css">
        ...
        body{
            background: url(img/slider-image2.jpg) no-repeat center fixed;
        background-size: cover;
        }
    </style>
   </head>

    <body background="C:\xampp\htdocs\project\file\slider-image2.jpg">
        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
               ...
               <?php include"Modal/DoctorModal.php"; ?>

                <?php include"file/sidebar.php"; ?>
                <div class="main-content">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add Doctor</button> <br><br>
                    <div class="container-fluid">
                      <!--   <h1>hello</h1> -->
                        <?php $co->viewTable("select * from employee_view") ?>
...
$(".btnEdit").click(function(){
   id=$(this).attr("update");
    ...
    var sql="select * from employee where em_no= '"+id+"' ";
