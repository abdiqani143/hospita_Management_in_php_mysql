        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                ...
                <div class="main-content">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add-Prescription</button> <br> <br>
                    <div class="container-fluid">
                      <!--   <h1>hello</h1> -->
                        <?php $co->viewTable("select * from prescription_view") ?>
