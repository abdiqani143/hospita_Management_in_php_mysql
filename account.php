        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                ...
                <div class="main-content">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add Account</button> <br><br>
                    <div class="container-fluid">
                      <!--   <h1>hello</h1> -->
                        <?php $co->viewTable("select * from accounts_view") ?>
...
$(".btnEdit").click(function(){
   id=$(this).attr("update");
    ...
    var sql="select * from accounts where acc_no= '"+id+"' ";
