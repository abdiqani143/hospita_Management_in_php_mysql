...
<html class="no-js" lang="en">
   ...
   <head>
    ...
    <body>
      ...
      <select style="width:200px; height:40px" id="patient">
          ...
          <?php $co->FillCombo("SELECT `Decter`,`Decter` FROM `visit_view`");?>
      </select>
 ...
 $(document).ready(function() {
    $('#example').DataTable();
    $("#divTable").load("reports/visit_report_all.php");
 ...
 $("#patient").change(function(){
    var name=$(this).val();
    $.post("reports/visit_report_indi.php","name="+name,function(res){
       $("#divTable").html(res); 
    })
 })
 //.................
