...
<html class="no-js" lang="en">
   ...
   <head>
    ...
    <body>
      ...
      <select style="width:200px; height:40px" id="patient">
          <option selected disabled value="">Select Prescription</option>
          <?php $co->FillCombo("SELECT `Dector`,`Dector` FROM `prescription_view`");?>
      </select>
 ...
 $(document).ready(function() {
    $('#example').DataTable();
    $("#divTable").load("reports/prescription_report_all.php");
 ...
 $("#patient").change(function(){
    var name=$(this).val();
    $.post("reports/prescription_report_indi.php","name="+name,function(res){
       $("#divTable").html(res); 
    })
 })
 //.................
