<?php
    ...
    if (isset($_POST['signup'])) {
        ...
        // count erros
        if (count($errors) === 0) {
            $insertQuery = "INSERT INTO users (name,username,email,password,code,type)
            VALUES ('$name','$username','$email','$password',$code,'$type')";
            ...
            if ($insertInfo) {
                ...
                $sender = 'From: abdiqanimohamud143@gmail.com';
    ...
    if (isset($_POST['login'])) {
        ...
        if (mysqli_num_rows($email_check) > 0) {
            ...
            if (mysqli_num_rows($password_check) > 0) {
                ...
                $name = $fetchInfo['name'] . " " . $fetchInfo['usernameame'];
                $_SESSION['name'] = $name;
