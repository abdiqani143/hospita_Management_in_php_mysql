   ...
   <head>
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                <?php include"Modal/BillsModal.php"; ?>
                <?php include"file/sidebar.php"; ?>
                <div class="main-content">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#demoModal">Add Bills</button> <br> <br>
                    <div class="container-fluid">
                      <!--   <h1>hello</h1> -->
                        <?php $co->viewTable("select * from bills_view") ?>
...
$(".btnEdit").click(function(){
   id=$(this).attr("update");
    ...
    var sql="select * from bills where bl_no= '"+id+"' ";
